    ...
    for (let name in global.comandos) {
            ...
            if (data.exists)
              m.reply(
                `*[ ⛔ 𝚁𝙴𝙿𝙾𝚁𝚃𝙴 𝙳𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙲𝙾𝙽 𝙵𝙰𝙻𝙻𝙾𝚂 ⛔ ]*\n\n*—◉ 🗂️ 𝙿𝙻𝚄𝙶𝙸𝙽:* ${name}\n*—◉ 👥 𝚄𝚂𝚄𝙰𝚁𝙸𝙾:* ${m.sender}\n*—◉ 🤖 𝙲𝙾𝙼𝙰𝙽𝙳𝙾:* ${
                  ...
                  e
                )}\`\`\`\n\n_. ᩭ✎Para hacer un reporte escriba : #reporte_`.trim(),
                data.jid
              );
          }
        }
      ...
      if ((usedPrefix = (match[0] || "")[0])) {
        ...
        if (!isPrems && comandos.dolares && global.db.data.users[m.sender].dolares < comandos.dolares * 1) {
          this.reply(
            m.chat,
            `${ag}\n_No tiene dólares 💵\n\n_puede conseguir 💵 con el comando #trabajar_`,
            m
          );
          continue;
        }
...
global.dfail = (type, m, conn) => { 
   let msg = { 
     rowner: "*[ 🛑 HEY ALTO 🛑 ] ESTE COMANDO SOLO PUEDE SER UTILIZADO POR MIS CREADORES*", 
     owner: "*[ 🛑 HEY ALTO 🛑 ] ESTE COMANDO SOLO PUEDE SER UTILIZADO POR MIS OWNER*", 
     ...
     admin: "*[ 🛑 HEY ALTO 🛑 ] ESTE COMANDO SOLO PUEDE SER UTILIZADO POR ADMINISTRADORES*", 
     botAdmin: "*[ 🛑 HEY ALTO 🛑 ] PARA PODER USAR ESTE COMANDO ES NECESARIO QUE EL BOT SEA ADMINISTRADOR*", 
       ...
       extendedTextMessage: { 
         ...
         contextInfo: { 
           externalAdReply: { 
             ...
             body: "ɴɪɢʜᴛᴄᴏʀᴇ〔ʙᴏᴛ〕", 
             thumbnail: imagen1, 
             sourceUrl: "https://wa.me/522212009202", 
           }, 
         }, 
       }, 
     }, 
